...
export const translations = {
  id: {
    ...
    payday_debts_paid_this_month: 'Angsuran / Hutang Dibayar Bulan Ini',
    payday_debts_due_this_month: 'Sisa Hutang Jatuh Tempo Bulan Ini',
    payday_payments_made: 'kali pembayaran angsuran',
    payday_due_debts_count: 'catatan hutang jatuh tempo bulan ini',
  ...
  en: {
    ...
    payday_debts_paid_this_month: 'Debt Payments Made This Month',
    payday_debts_due_this_month: 'Remaining Debt Due This Month',
    payday_payments_made: 'installment payments made',
    payday_due_debts_count: 'debts due this month',
    payday_debts_principal: 'Debt Principal / Installments',
    payday_active_debts: 'active debt records',
    payday_spent: 'Spent This Month',
